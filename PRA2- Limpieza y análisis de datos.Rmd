...
Finalmente, con el objetivo de comprobar qué diferencia a los vino de buena calidad, creamos una nueva columna que indique si la calidad del vino es buena (7 o más) o no:

```{r message= FALSE, warning=FALSE}
wines$good.wine <- ifelse(wines$quality>6,1,0)
```
...
Comprobamos si se cumplen para cada una de los atributos de los que disponemos:
